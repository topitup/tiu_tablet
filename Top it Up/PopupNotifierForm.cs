...
namespace TopitUp
{
    ...
    internal class PopupNotifierForm : System.Windows.Forms.Form
    {
            ...
            get
            {
                if (Parent.Image != null)
                {
                    return new RectangleF(
                        Parent.ImagePadding.Left +  Parent.ImagePadding.Right + Parent.ContentPadding.Left,
                        Parent.HeaderHeight + Parent.TitlePadding.Top + heightOfTitle + Parent.TitlePadding.Bottom + Parent.ContentPadding.Top + 5,
                ...
                else
                {
                    return new RectangleF(
                        ...
                        this.Height - Parent.HeaderHeight - Parent.TitlePadding.Top  - Parent.TitlePadding.Bottom - Parent.ContentPadding.Top - Parent.ContentPadding.Bottom - 1);
                }
            }
        }
        ...
        {
            rcBody = new Rectangle(3, 3, this.Width - 6, this.Height - 6);
        ...
        private void PopupNotifierForm_Paint(object sender, PaintEventArgs e)
        {
            ...
            if (Parent.Image != null)
            {
               // e.Graphics.DrawImage(Parent.Image, Parent.ImagePadding.Left, Parent.HeaderHeight + Parent.ImagePadding.Top, Parent.ImageSize.Width, Parent.ImageSize.Height);
                e.Graphics.DrawImage(Parent.Image, Parent.Size.Width - Parent.Image.Width - 20, Parent.HeaderHeight + Parent.ImagePadding.Top + 20, Parent.ImageSize.Width, Parent.ImageSize.Height);
            }
