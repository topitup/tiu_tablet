...
namespace TopitUp
{
    ...
    public class PopupNotifier : Component
    {
        ...
        public PopupNotifier()
        {
            ...
            //BodyColor = Color.FromArgb(255, 222, 222, 222); //SystemColors.Control;
            ...
            ContentFont = font; // SystemFonts.CaptionFont;
            ...
            {
                Size = new Size(Util._home_form.Width - 240, 95);
            }
            else
            {
                Size = new Size(Screen.PrimaryScreen.WorkingArea.Width - 240, 95);
            }
            ...
            //frmPopup.BackColor = Color.FromArgb(255, 156, 162, 162);
            frmPopup.BackColor = Color.FromArgb(255, 0, 0,0);
            ...
            if (!disposed)
            {
                if (!frmPopup.Visible)
                {
                    ...
                    else
                    {
                        ...
                        if (globalSettings.allow_screen_resize == "1")
                        {
                            posStart = Util._home_form.Top + 32;
                            posStop = Util._home_form.Top + 32;
                        }
                        else
                        {
                            posStart = 2;
                    ...
                    if (globalSettings.allow_screen_resize == "1")
                    {
                        frmPopup.Location = new Point((Util._home_form.Left + Util._home_form.Width) - frmPopup.Size.Width - 6, Util._home_form.Top + 2);
                    }
                    else
                    {
                        frmPopup.Location = new Point(Screen.PrimaryScreen.WorkingArea.Right - frmPopup.Size.Width - 2, 2);
                    }
